...
var HinocChartReact = function (_React$Component) {
    ...
    function HinocChartReact() {
        var _ref;

        _classCallCheck(this, HinocChartReact);

        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
        }

        var _this = _possibleConstructorReturn(this, (_ref = HinocChartReact.__proto__ || Object.getPrototypeOf(HinocChartReact)).call.apply(_ref, [this].concat(args)));
    ...
    _createClass(HinocChartReact, [{
        ...
        value: function render() {
            ...
            return _react.React.createElement(
                "div",
                { className: "col-md-12 panel panel-default", style: { height: 460 } },
                _react.React.createElement(
                    "div",
                    { className: "col-md-12 panel-heading panel-primary", ref: function ref(ele) {
                            self._echartBar = ele;
                        } },
                    _react.React.createElement(
                        "button",
                        { type: "button", className: "btn btn-default", ref: function ref(ele) {
                                self._showConfigButton = ele;
                            } },
                        _react.React.createElement("span", { className: "glyphicon glyphicon-arrow-down", "aria-hidden": "true" })
                    ),
                    _react.React.createElement(
                        "button",
                        ...
                        _react.React.createElement("span", { className: "glyphicon glyphicon-remove", "aria-hidden": "true" })
                    )
                ),
                _react.React.createElement("div", { className: "col-md-12", ref: function ref(ele) {
                        self._echartContainer = ele;
                    }, style: { height: 400 } })
            );
        }
    }, {
        ...
        value: function componentDidUpdate() {
            ...
            var data = this.props.chartValue.map(function (x) {
                return { name: x[0].split(".")[0].replace("T", " "), value: [x[0].split(".")[0].replace("T", " "), x[1]] };
            });
    ...
    return HinocChartReact;
}(_react.React.Component);

var QueryModalReact = function (_React$Component2) {
    _inherits(QueryModalReact, _React$Component2);

    function QueryModalReact() {
        var _ref2;

        _classCallCheck(this, QueryModalReact);

        for (var _len2 = arguments.length, args = Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {
            args[_key2] = arguments[_key2];
        }

        var _this4 = _possibleConstructorReturn(this, (_ref2 = QueryModalReact.__proto__ || Object.getPrototypeOf(QueryModalReact)).call.apply(_ref2, [this].concat(args)));
    ...
    _createClass(QueryModalReact, [{
        ...
        value: function render() {
            ...
            return _react.React.createElement(
                "div",
                { className: "modal fade", tabIndex: "-1", role: "dialog", "aria-hidden": "true", ref: function ref(ele) {
                        self._modal = ele;
                    } },
                _react.React.createElement(
                    "div",
                    ...
                    _react.React.createElement(
                        ...
                        _react.React.createElement(
                            ...
                            _react.React.createElement("input", { type: "text", className: "form-control", "place-holder": "SELECT * FROM /.*/", ref: function ref(ele) {
                                    _this5._queryString = ele;
                                } })
                        ),
                        _react.React.createElement(
                            "div",
                            { className: "input-group date", ref: "startTimeSelector" },
                            _react.React.createElement(
                                "span",
                                { className: "input-group-btn add-on" },
                                _react.React.createElement(
                                    "button",
                                    { type: "button", className: "btn btn-default" },
                                    "Start ",
                                    _react.React.createElement("span", { className: "glyphicon glyphicon-calendar", "aria-hidden": "true" })
                                )
                            ),
                            _react.React.createElement("input", _defineProperty({ type: "text", className: "form-control", "data-format": "yyyy-MM-dd HH:mm:ss" }, "type", "text"))
                        ),
                        _react.React.createElement(
                            "div",
                            { className: "input-group date", ref: "endTimeSelector" },
                            _react.React.createElement(
                                "span",
                                { className: "input-group-btn add-on" },
                                _react.React.createElement(
                        ...
                        _react.React.createElement(
                            "button",
                            { className: "btn btn-primary", type: "button", ref: "realtimebtn", onClick: function onClick() {
                                    _this5.switchRealTimeMode();
                                } },
                            this.state.realtimeMode
                        )
                    ),
                    _react.React.createElement(
                        "div",
        ...
        key: "checkQuerySafe",
        value: function checkQuerySafe(query) {
            //TODO: complex checking the query statement's illegal
            return true;
        }
    }, {
        key: "switchRealTimeMode",
        value: function switchRealTimeMode() {
    ...
    return QueryModalReact;
}(_react.React.Component);

var HinocChartModuleReact = function (_React$Component3) {
    _inherits(HinocChartModuleReact, _React$Component3);

    function HinocChartModuleReact() {
        var _ref3;

        _classCallCheck(this, HinocChartModuleReact);
    ...
    _createClass(HinocChartModuleReact, [{
        ...
        value: function render() {
            ...
            return this.state.mouduleClose ? null : _react.React.createElement(
                "div",
                { className: "hinoc-chart-container" },
                _react.React.createElement(HinocChartReact, { charttype: this.props.charttype, showConfigTrigger: function showConfigTrigger() {
                        _this7.showConfig();
                    },
                ...
                _react.React.createElement(QueryModalReact, { showConfig: this.state.showConfig, clearShowFlag: function clearShowFlag() {
                        _this7.clearFlag();
                    },
...
$(document).ready(function () {
    ...
    document.getElementById("add-liner-btn").onclick = function () {
        arr.push(_react.React.createElement(HinocChartModuleReact, { key: hinocChartCounter, charttype: "line" }));
        hinocChartCounter++;
        _reactDom.ReactDOM.render(arr, chartContainer);
    };

    document.getElementById("add-bar-btn").onclick = function () {
        arr.push(_react.React.createElement(HinocChartModuleReact, { key: hinocChartCounter, charttype: "bar" }));
        hinocChartCounter++;
        _reactDom.ReactDOM.render(arr, chartContainer);
    };
...
exports.EventListener = EventProxy;
